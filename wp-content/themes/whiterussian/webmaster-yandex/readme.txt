...
Send your original texts to Yandex Webmaster service
...
2. Set Application Id, Application password in plugin settings page (fetch them at https://oauth.yandex.ru/ after you create your own app);
3. Get code and paste it in appropriate field;
